...
<head>
    ...
    <title>About Us | Nami Lontar</title>
    <meta name="description"
        content="Discover the story behind Nami Lontar - our passion for artisanal baking and legacy of perfection.">
    ...
    <main>
        ...
        <section class="chefs container">
            ...
            <div class="chef-grid">
                <div class="chef-card">
                    <div class="chef-img">
                        <img src="../assets/chef1.png" alt="Chef Marcus">
                    </div>
                    <div class="chef-info">
                        <h3>Marcus Chen</h3>
                ...
                <div class="chef-card">
                    <div class="chef-img">
                        <img src="../assets/chef2.png" alt="Chef Sarah">
                    </div>
                    <div class="chef-info">
                        <h3>Sarah Jenkins</h3>
                ...
                <div class="chef-card">
                    <div class="chef-img">
                        <img src="../assets/chef3.png" alt="Chef David">
                    </div>
                    <div class="chef-info">
                        <h3>David Miller</h3>
                        <p>Artisan Baker</p>
                ...
                <div class="chef-card">
                    <div class="chef-img">
                        <img src="../assets/chef4.png" alt="Chef Elena">
                    </div>
                    <div class="chef-info">
                        <h3>Elena Rossi</h3>
                        <p>Cake Designer</p>
