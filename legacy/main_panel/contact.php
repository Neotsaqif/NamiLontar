...
<head>
    ...
    <title>Contact Us | Nami Lontar</title>
    <meta name="description"
        content="Get in touch with Nami Lontar for any questions about our artisanal cakes and pastries.">
...
<body>
    ...
    <main>
        ...
        <section class="contact-hero">
            <div class="hero-bg">
                <img src="../assets/about_hero_bg.png" alt="Bakery Background">
            </div>
